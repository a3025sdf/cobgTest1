...
#长句子划分为多个短句，注意：sliding_len是步进长度
...
loss_func = bias_loss()
#这里的bias_loss看上去似乎是把权重应用到损失函数中，但是并没有传weight？
    ...
    for ep in range(num_epoch):
        ...
        if valid_f1 >= max_f1: 
            ...
            if valid_f1 > config["f1_2_save"]: # save the best model
                ...
                torch.save(rel_extractor.state_dict(), os.path.join(model_state_dict_dir, "model_state_dict_{}_f1{}.pt".format(modle_state_num,valid_f1)))
...
#todo 我怀疑从断点开始重新跑的时候，那个实体和关系的学习平衡权重也会重置
